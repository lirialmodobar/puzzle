...
adapted_by: Liriel Almodobar, Lucas Toshio Ito
---
...
```{r}
## NAT RS
count_nat_rs <- read.table("/home/yuri/liri/puzzle/rs/nat/chr_info_unfilt/count_info/freqs_chr_2_nat_rs.txt", header=F)
...
##NAT SP
count_nat_sp <- read.table("/home/yuri/liri/puzzle/sp/nat/chr_info_unfilt/count_info/freqs_chr_2_nat_sp.txt", header=F)
...
## Plotting parameters
```{r}
max_score <- max(count_nat_sp$score, count_nat_rs$score)
...
### Annotate y-axis
annoYaxis(
  plot = signalplot, at = round(seq(min_score, max_score+20, by = 20), digits = 0), ##version with negative values
...
### Annotate y-axis
annoYaxis(
   plot = signalplotNATSP, at = round(seq(min_score, max_score+20, by = 20), digits = 0), ##version with negative values
   axisLine = FALSE, fontsize = 9
)
### Plot y-axis label
plotText(
...
ticks <- seq(1, 242e6, by = 20e6)  # Define tick positions
annoXaxis(
    plot = signalplotNATSP,
    at = format(ticks, scientific = TRUE),
...
##chr (start and end numbers in draft)

region <- pgParams(chrom = "chr2", chromstart = 1, chromend = 35000000)
annoHighlight(
  plot = ideogramPlot, params = region,
 fill = "salmon",
y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
)
region <- pgParams(chrom = "chr2", chromstart = 38000000, chromend = 64000000)
annoHighlight(
  plot = ideogramPlot, params = region,
 fill = "salmon",
y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
)
region <- pgParams(chrom = "chr2", chromstart = 150000000, chromend = 220000000)
annoHighlight(
...
# refined regions (originally +-1kb, but due to scale issues, for visualization purposes only, they are at +-200kb scale)

region <- pgParams(chrom = "chr2", chromstart = 3800000, chromend = 4200000)
annoHighlight(
 plot = ideogramPlot, params = region,
 fill = "firebrick",
y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
)
region <- pgParams(chrom = "chr2", chromstart = 57800000, chromend = 58200000)
annoHighlight(
  plot = ideogramPlot, params = region,
  fill = "firebrick",
  y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
)
region <- pgParams(chrom = "chr2", chromstart = 210800000, chromend = 211200000)
annoHighlight(
  plot = signalplotNATSP, params = region,
 fill = "firebrick",
y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
...
## refined 
##chr 1
#region <- pgParams(chrom = "chr1", chromstart = 19800000, chromend = 20200000)
#annoHighlight(
 #plot = ideogramPlot, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr1", chromstart = 68800000, chromend = 69200000)
#annoHighlight(
 # plot = ideogramPlot, params = region,
  #fill = "firebrick",
  #y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr1", chromstart = 170800000, chromend = 171200000)
#annoHighlight(
  #plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr1", chromstart = 235100000 , chromend = 236200000)
#annoHighlight(
 # plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
...
#region <- pgParams(chrom = "chr3", chromstart = 15700000, chromend = 16100000)
#annoHighlight(
 #plot = ideogramPlot, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr3", chromstart = 54800000, chromend = 55200000)
#annoHighlight(
 # plot = ideogramPlot, params = region,
  #fill = "firebrick",
  #y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr3", chromstart = 164800000, chromend = 165200000)
#annoHighlight(
 # plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr3", chromstart = 181800000 , chromend = 182200000)
#annoHighlight(
 # plot = signalplotNATSP, params = region,
# fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr1", chromstart = 148800000 , chromend = 149200000)
#annoHighlight(
 # plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
...
#region <- pgParams(chrom = "chr4", chromstart = 89800000, chromend = 90200000)
#annoHighlight(
 #plot = ideogramPlot, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr4", chromstart = 109500000, chromend = 109900000)
#annoHighlight(
  #plot = ideogramPlot, params = region,
  #fill = "firebrick",
 # y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr4", chromstart = 167800000, chromend = 168200000)
#annoHighlight(
  #plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
...
#region <- pgParams(chrom = "chr5", chromstart = 23800000, chromend = 24200000)
#annoHighlight(
 #plot = ideogramPlot, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr5", chromstart = 78300000, chromend = 78700000)
#annoHighlight(
  #plot = ideogramPlot, params = region,
  #fill = "firebrick",
 # y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr5", chromstart = 117800000, chromend = 118200000)
#annoHighlight(
  #plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
#)
#region <- pgParams(chrom = "chr5", chromstart = 139800000 , chromend = 140200000)
#annoHighlight(
  #plot = signalplotNATSP, params = region,
 #fill = "firebrick",
#y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 1
