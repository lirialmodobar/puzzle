...
#region <- pgParams(chrom = "chr1", chromstart = 13000000, chromend = 24000000) ## sp+104
region <- pgParams(chrom = "chr1", chromstart = 18000000, chromend = 30000000) ## pode ser a mesma, na vdd e a mesma expandida
annoHighlight(
    plot = ideogramPlot, params = region,
    fill = "salmon",
    y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
)
region <- pgParams(chrom = "chr1", chromstart = 60000000, chromend = 76000000) ##sp+104 e sp + 104 - 339
annoHighlight(
...
#region <- pgParams(chrom = "chr1", chromstart = 166000000, chromend = 176000000) ##sp+104
region <- pgParams(chrom = "chr1", chromstart = 16300000, chromend = 190000000) ## pode ser a mesma, na vdd acho que e a mesma expandida
annoHighlight(
    plot = ideogramPlot, params = region,
    fill = "salmon",
    y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
...
region <- pgParams(chrom = "chr1", chromstart = 220000000, chromend = 250000000) ##sp+104 and sp + 104 - 339
annoHighlight(
    plot = ideogramPlot, params = region,
    fill = "salmon",
    y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
...
region <- pgParams (chrom = "chr1", chromstart = 2000000, chromend = 16000000)
annoHighlight(
    plot = ideogramPlot, params = region,
    fill = "salmon",
    y = 0.45, height = 0.3, just = c("left", "top"), default.units = "inches", alpha = 0.3
